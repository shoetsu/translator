...
params_list=(log_file interactive cleanup dataset_type train_data_path test_data_path evaluate_data_path debug batch_size vocab_size target_attribute num_train_data)
